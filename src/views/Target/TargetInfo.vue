...
export default {
        ...
        },
        {
          ...
          render: (h, params) => {
            return h('div', {
              ...
              on: {
                click: () => {
                  this.$emit("flyToTarget", params.row)
                }
              }
            }, params.row.name)
          }
  ...
  mounted() {
    this.targetInfoData = globalConfig.targetInfoData;
    this.total = globalConfig.targetInfoData.length;
  },
  methods: {
    changePage(num) {
